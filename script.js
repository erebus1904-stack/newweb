const i18n = {
  zh: {
    ...
    heroTitle: "海外证件与执照考试，一站式刷题学习",
    brandSubtitle: "海外证照学习库",
    navAll: "全部考试",
    navAllSmall: "跨国家、州、省和证照类型",
    navDmv: "驾照 / CDL",
    navDmvSmall: "美国 DMV, 商业驾照",
    navRealEstate: "房地产执照",
    navRealEstateSmall: "州级销售员考试",
    navCitizenship: "入籍考试",
    navCitizenshipSmall: "加拿大 / 英国 / 美国",
    navFinance: "金融证券",
    navHealth: "护理 / 食安",
    todayGoal: "今日目标",
    languageLabel: "语言",
  ...
  en: {
    ...
    navAll: "All exams",
    navAllSmall: "Countries, regions, and credential types",
    navDmv: "Driver / CDL",
    navDmvSmall: "US DMV and commercial driving",
    navRealEstate: "Real estate license",
    navRealEstateSmall: "State salesperson exams",
    navCitizenship: "Citizenship tests",
    navCitizenshipSmall: "Canada / UK / US",
    navFinance: "Financial licenses",
    navHealth: "Nursing / food safety",
    todayGoal: "Today",
    ...
    etaLabel: "ETA",
    nextStep: "Next steps",
    catalogTitle: "Question banks organized by country, region, and credential type",
    all: "All",
    exams: "exams",
    source: "Source",
    coverage: "Covers",
    ...
    dailyExam: "Finish one mock exam and review mistakes",
    progress: (index, total) => `${index} / ${total}`,
    hiddenExplanation: "In exam mode, explanations appear after submission.",
    advicePass: "Nearly ready",
    advicePractice: "Keep strengthening",
    adviceStudy: "Return to study mode",
    perfectReport: "You answered every question correctly. Try another set to confirm mastery.",
    ...
    planExam: "After the exam, review every missed explanation",
