...
const cleanUiText = {
  ...
  zh: {
    htmlLang: "zh-CN",
    heroEyebrow: "以练习为核心的考试平台",
    heroTitle: "海外证书与执照考试短训题库",
    brandSubtitle: "海外证书学习题库",
    navAll: "全部项目",
    navAllSmall: "按行业、证书和训练重点筛选",
    navMedical: "医疗与护理",
    navMedicalSmall: "NCLEX-RN, USMLE",
    navFinance: "财会与金融",
    navFinanceSmall: "USCPA, CFA, FINRA",
    navEngineering: "工程与 IT",
    navEngineeringSmall: "FE/PE, AWS, GCP",
    navProject: "项目管理",
    navProjectSmall: "PMP, agile, hybrid delivery",
    navLaw: "法律与公共服务",
    ...
    etaLabel: "预计",
    nextStep: "下一步",
    catalogTitle: "按行业、证书和训练重点组织的原创练习题",
    all: "全部",
    programs: "个项目",
    source: "来源",
    coverage: "覆盖",
    ...
    advicePractice: "继续强化",
    adviceStudy: "回到学习模式",
    perfectReport: "本组短训全部答对。建议再换一组题确认掌握情况。",
    wrongReport: (tags) => `优先复盘：${tags}。建议切回学习模式逐题查看解析。`,
    planWeak: (weak) => `先复习薄弱项：${weak}`,
    planPractice: (topic, count) => `完成 ${count} 道 ${topic} 相关练习`,
    planDrill: "短训结束后复盘所有错题解析",
    planStudy: "学习模式下每题读完解析再进入下一题",
    localTitle: "本地学习数据",
    ...
    clearMistakes: "清空错题",
    noMistakes: "当前项目暂无错题。",
    noMistakesDetail: "答错题目后，这里会生成错题复习队列。",
    practiceAction: "练习",
    detailsAction: "详情",
    weakNone: "暂无",
    etaStart: "开始后估算",
  ...
  ja: {
    htmlLang: "ja",
    heroEyebrow: "Practice-first training platform",
    heroTitle: "海外資格とライセンス試験の短期ドリル",
    brandSubtitle: "海外資格学習ライブラリ",
    navAll: "すべてのプログラム",
    navAllSmall: "分野、資格、学習重点で絞り込み",
    navMedical: "医療・看護",
    navMedicalSmall: "NCLEX-RN, USMLE",
    navFinance: "会計・金融",
    navFinanceSmall: "USCPA, CFA, FINRA",
    ...
    etaLabel: "目安",
    nextStep: "次の学習",
    catalogTitle: "分野、資格、学習重点別のオリジナル練習問題",
    all: "すべて",
    programs: "プログラム",
    source: "出典",
    coverage: "範囲",
    ...
    updated: "更新",
    dailyStudy: "30問 + 間違い復習",
    dailyDrill: "短期ドリルを1回完了して復習",
    progress: (index, total) => `${index} / ${total} 問`,
    hiddenExplanation: "ドリルモードでは完了後に解説が表示されます。",
    advicePass: "合格圏に近い",
    advicePractice: "さらに強化",
    adviceStudy: "学習モードへ戻る",
    perfectReport: "すべて正解です。別のセットでも確認しましょう。",
    wrongReport: (tags) => `優先復習: ${tags}。学習モードで解説を確認しましょう。`,
    planWeak: (weak) => `弱点を先に復習: ${weak}`,
    planPractice: (topic, count) => `${topic} の練習を ${count} 問`,
    planDrill: "ドリル後に間違えた問題の解説を復習",
    planStudy: "各解説を読んでから次へ進む",
    localTitle: "ローカル学習データ",
    localSubtitle: "このブラウザにのみ保存",
    localAnswered: "回答済み",
    localAccuracy: "正答率",
    ...
    clearMistakes: "ミスを削除",
    noMistakes: "このプログラムにはまだミスがありません。",
    noMistakesDetail: "間違えた問題はここに復習用として表示されます。",
    practiceAction: "練習",
    detailsAction: "詳細",
    weakNone: "なし",
    etaStart: "開始後に推定",
...
cleanUiText.ko = {
  ...cleanUiText.en,
  htmlLang: "ko",
  heroTitle: "해외 자격 및 면허 시험 단기 드릴",
  brandSubtitle: "해외 자격 학습 라이브러리",
  navAll: "전체 프로그램",
  navAllSmall: "분야, 자격, 학습 초점으로 필터링",
  navMedical: "의료 및 간호",
  navFinance: "회계 및 금융",
  navEngineering: "공학 및 IT",
  navProject: "프로젝트 관리",
...
cleanUiText.es = {
  ...cleanUiText.en,
  htmlLang: "es",
  heroTitle: "Práctica breve para credenciales y licencias internacionales",
  brandSubtitle: "Biblioteca de estudio para credenciales internacionales",
  navAll: "Todos los programas",
  navMedical: "Medicina y enfermería",
  navFinance: "Contabilidad y finanzas",
  navEngineering: "Ingeniería y TI",
  navProject: "Gestión de proyectos",
  navLaw: "Derecho y servicio público",
  todayGoal: "Meta de hoy",
  languageLabel: "Idioma",
  startMock: "Iniciar práctica",
  searchLabel: "Buscar",
...
cleanUiText.fr = {
  ...cleanUiText.en,
  htmlLang: "fr",
  heroTitle: "Entraînement court pour certifications et licences internationales",
  brandSubtitle: "Bibliothèque d'étude des certifications internationales",
  navAll: "Tous les programmes",
  navMedical: "Médecine et soins",
  navFinance: "Comptabilité et finance",
  navEngineering: "Ingénierie et IT",
  navProject: "Gestion de projet",
  navLaw: "Droit et service public",
  todayGoal: "Objectif du jour",
  languageLabel: "Langue",
  startMock: "Lancer l'entraînement",
  ...
  clearMistakes: "Effacer les erreurs",
  practiceAction: "Pratiquer",
  detailsAction: "Détails",
  progress: (index, total) => `${index} / ${total}`,
  etaDays: (days) => `${days} jours`
};

const cleanProgramText = {
  en: programText.en,
  zh: {
    "nclex-rn": { title: "NCLEX-RN 护理题库", subtitle: "美国护理执照练习", badge: "护理", description: "覆盖优先级、药理、安全、母婴和儿科的原创短训题。", coverage: ["成人护理", "药理", "母婴", "儿科", "安全"] },
    usmle: { title: "USMLE 医学练习", subtitle: "美国医师 Step 1-3", badge: "医学", description: "围绕病理、生理、药理、生统和临床案例的原创练习。", coverage: ["病理", "生理", "药理", "生物统计", "临床案例"] },
    uscpa: { title: "USCPA 会计练习", subtitle: "美国 CPA 科目", badge: "会计", description: "覆盖 FAR、AUD、REG、ISC 和模拟题思路的原创练习。", coverage: ["FAR", "AUD", "REG", "ISC", "TBS 模拟"] },
    cfa: { title: "CFA 金融练习", subtitle: "CFA Level I/II/III", badge: "金融", description: "覆盖伦理、数量、组合、权益和固收的原创练习。", coverage: ["伦理", "数量", "组合管理", "权益", "固定收益"] },
    finra: { title: "FINRA 证券执照", subtitle: "SIE & Series 7", badge: "证券", description: "覆盖适当性、产品、市场、监管和账户的证券执照练习。", coverage: ["SIE", "Series 7", "监管", "适当性", "产品"] },
    "fe-pe": { title: "FE/PE 工程练习", subtitle: "美国工程师考试", badge: "工程", description: "覆盖工程经济、静力、流体、伦理和手册检索的练习。", coverage: ["工程经济", "静力学", "流体", "伦理", "手册检索"] },
    pmp: { title: "PMP 项目管理练习", subtitle: "PMI 项目管理认证", badge: "PMP", description: "覆盖人员、流程、商业环境、敏捷和混合交付的情景题。", coverage: ["人员", "流程", "商业环境", "敏捷", "混合交付"] },
    "cloud-architect": { title: "云架构师认证", subtitle: "AWS & GCP 练习", badge: "云", description: "覆盖架构、安全、网络、可靠性和成本的云场景题。", coverage: ["架构", "安全", "网络", "可靠性", "成本"] },
    bar: { title: "美国 Bar 法律练习", subtitle: "NY & CA Bar", badge: "法律", description: "覆盖 MBE、MEE、证据法、合同和宪法的原创练习。", coverage: ["MBE", "MEE", "证据法", "合同", "宪法"] },
    "real-estate": { title: "美国地产经纪执照", subtitle: "地产执照练习", badge: "地产", description: "覆盖代理、合同、产权、州法和地产计算的练习。", coverage: ["代理", "合同", "产权", "州法", "地产计算"] }
  }
};

cleanProgramText.ja = programText.en;
cleanProgramText.ko = programText.en;
cleanProgramText.es = programText.en;
cleanProgramText.fr = programText.en;
