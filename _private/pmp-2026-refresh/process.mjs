export const processQuestions = [
  ...
  },
  {
    ...
    approach: "Predictive",
    difficulty: "Hard",
    decisionRule: "reassess trigger evidence and execute the authorized response before improvising a new one.",
    text: "A low-probability flood risk has an approved response to relocate stored equipment when river gauges cross a defined threshold. Forecasts now show the threshold will likely be crossed tonight, but no damage has occurred. What should the project manager do?",
    choices: [
      "Wait for visible flooding because moving equipment early could waste contingency funds",
      "Escalate directly to the sponsor to redesign the entire response strategy",
      "Confirm the trigger evidence and activate the planned relocation through its assigned owner",
      "Close the risk and open an issue because the forecast makes the flood effectively certain",
    ],
    correct: 2,
    explanation: "The defined trigger is imminent and an approved response already exists, so its evidence should be confirmed and the owner should act. Waiting defeats the trigger, strategic redesign delays protection without new evidence of inadequacy, and a forecast does not mean damage has already become an issue.",
    chapterId: "pmbok-ch11-risk-management",
  },
  {
    tag: "Risk and uncertainty",
  ...
  },
  {
    ...
    choices: [
      "Assign a conservative estimate and begin the full implementation to generate learning",
      "Create a timeboxed technical and data experiment with success criteria, then refine the item",
      "Remove the item permanently because repeated uncertainty makes its value unattainable",
      "Ask legal counsel to estimate the engineering work based on the available interpretation",
    ],
    correct: 1,
    explanation: "The unresolved uncertainty concerns technical utility, not only legal interpretation, so a bounded experiment should generate evidence before a full commitment. A padded estimate does not answer feasibility, permanent removal discards potential value, and legal expertise cannot substitute for engineering and data validation.",
    chapterId: "pmbok-ch11-risk-management",
  },
  {
    tag: "Risk and uncertainty",
