...
export const seoPages = [
  ...
  { path: "blog.html", lastmod: "2026-08-09", index: true, schema: [] },
  ...
  { path: "programs/pmp.html", lastmod: "2026-08-09", index: true, schema: ["LearningResource", "BreadcrumbList", "ItemList"] },
