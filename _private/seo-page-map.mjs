...
export const seoPages = [
  ...
  { path: "blog.html", lastmod: "2026-09-04", index: true, schema: [] },
  ...
  { path: "programs/pmp.html", lastmod: "2026-09-04", index: true, schema: ["LearningResource", "BreadcrumbList", "ItemList"] },
