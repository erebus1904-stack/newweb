...
requireMatch(materialGuide, /Starting in late Q4 2026/i, "PMP material guide does not explain the planned live-training rule change.");
...
requireMatch(materialGuide, /specific start date/i, "PMP material guide does not explain that the exact training-rule date is pending.");
